...
class AvatarServicePhpUnitTest extends TestCase
{
    ...
    public function test_it_stores_avatar_from_binary_data()
    {
    ...
    public function test_it_returns_null_for_invalid_base64()
    {
        $path = $this->service->storeAvatarFromBase64($this->user, 'invalid-data');
        $this->assertNull($path);
    }

    public function test_it_deletes_existing_avatar()
    {
