...
@section('title', __('filament-entry-links::public.unavailable_title'))

@section('content')
    <div class="container mx-auto px-4 py-16 sm:py-24 max-w-lg text-center">
        <h1 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">{{ __('filament-entry-links::public.unavailable_heading') }}</h1>
        <p class="text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">{{ __('filament-entry-links::public.unavailable_body') }}</p>
        <a href="{{ $homeUrl }}"
