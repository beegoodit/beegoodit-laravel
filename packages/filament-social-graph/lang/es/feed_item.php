...
return [
    ...
    'body' => 'Contenido',
    'owner' => 'Propietario',
    'owner_required_hint' => 'Selecciona un propietario o configura owner_models en config/filament-social-graph.php. Ejecuta php artisan config:clear si ya lo has hecho.',
